...
pub fn build(b: *std.Build) void {
    ...
    // Defaults to ReleaseSafe so benchmarks and normal builds get optimized code with safety
    // checks. Override with `-Doptimize=Debug` when needed.
    ...
    const mod = b.addModule("state_machines", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "state_machines" is the name you will use in your source code to
                // import this module (e.g. `@import("state_machines")`). The name is
